...
export default function AdminPenyaluranPage() {
  ...
  return (
    <PageShell title="Penyaluran Dana" subtitle="Pilih donasi yang sudah diverifikasi, isi jumlah disalurkan, unggah foto bukti, lalu sistem menulis ke SQL dan timeline.">
      <div className="grid gap-6 xl:grid-cols-[420px_1fr]">
        <Card>
          ...
          <form className="mt-4 space-y-3" onSubmit={handleSubmit}>
            <SelectField value={form.id_donasi} onChange={(e) => setForm((prev) => ({ ...prev, id_donasi: e.target.value }))}>
              <option value="">Pilih donasi verifikasi</option>
        ...
        <Card>
          <div className="flex items-center justify-between">
            <h2 className="font-display text-2xl font-bold">Donasi verifikasi</h2>
